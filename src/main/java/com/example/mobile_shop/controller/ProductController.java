...
import com.example.mobile_shop.config.MvcConfig;
...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDTO>> sortProductAsc(){
        List<ProductDTO> list = iProductService.sortProductAsc();
